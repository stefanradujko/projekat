               ...
               $.getJSON(url, function(odgovorServisa) {
                   ...
                   $.each(odgovorServisa.proizvod,function(i, proizvod) {
                       $("#ajaxPodaci").append("<tr>"+
                               "<td><a href='updateproizvod.php?proizvodID="+ proizvod.proizvodID +"'><button class='button-update'>Izmena</button></a></td>"+
                               ...
                               "<td><a href='delete.php?proizvodID="+ proizvod.proizvodID +"'><button class='button-delete'>Brisanje</button></a></td>"+
                               "</tr>");
                   })
               });
           }
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
           <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false">
            ...
            <a class="navbar-brand" href="index.php">
                <img id="logo" src="img/book.png" alt="proizvod_logo"/>
            </a>
          </div>
          ...
          if (isset($_SESSION['username']) && !empty($_SESSION['username'])) {   /*proverava da li ima sesije odnosno da li je neko ulogovan,ako je ulogovan onda otvara mogucnost Izlaza a ako nije onda otvara mogucnost za ulaz i registraciju*/
            ...
            <li><a href="insertproizvod.php">Unos</a></li>
...
<div id="container">
  <div class="container_header">
    <br>
    <h1>Izmena/brisanje proizvod</h1>
    <br>
  </div>
                      ...
                      <tbody id="ajaxPodaci">
                          <?php
                              foreach($json_objekat->proizvod as $proizvod) {
                                  echo "<tr>
                                          <td><a href='updateproizvod.php?proizvodID=". $proizvod->proizvodID ."'><button class='button-update'>Izmeni</button></a></td>
                                          <td>$proizvod->proizvodNaziv</td>
                                          <td>$proizvod->brojSerije</td>
                                          <td>$proizvod->proizvodStanje</td>
                                          <td>$proizvod->proizvodCena</td>
                                          <td>$proizvod->proizvodjacNaziv $proizvod->proizvodjacAdresa</td>
                                          <td><a href='delete.php?proizvodID=". $proizvod->proizvodID ."'><button class='button-delete'>Obriši</button></a></td>
                                      </tr>";
                              }
                          ?>
                      </tbody>
