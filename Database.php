...
function select2 ($table="proizvodi", $columns = '*', $join_table=" ", $join_key1=" ", $join_key2=" ", $join_table2=" ", $join_key3=" ", $join_key4=" ",$where = null, $order = null)
{
    ...
    $this->ExecuteQuery($q);
        ...
        function insert($table = "proizvod", $rows = "proizvodNaziv,brojSerije,proizvodStanje,proizvodCena,proizvodjacID", $values) {
        ...
        function update($table = "proizvod", $id, $keys, $values) {
            ...
            $update = "UPDATE ". $table ." SET ". $set_query_string ." WHERE proizvodID=". $id;
